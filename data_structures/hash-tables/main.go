...
// bucketNode is a linked list node that holds a key and address to the next node
...
// search bucket will take in a key and return true if the bucket has the key
